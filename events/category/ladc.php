...
<p style="font-size: 20px;">Welcome to the LADC! <br>It is the place to be, when you want to showcase what you have got. It helps you to discover your own talent and work on it to bring out a better 'you'. For more information
&#44;<a href="https://www.facebook.com/ladsnitj/"> click here</a></p>
...
<div class="preview-info__content">
        ...
        <ul class="preview-info__team">
                ...
                <li class="preview-info__member">
                    <span class="preview-info__name" style="font-size: 20px;">Akshit Sodhi</span><br>
                 <span class="preview-info__role style=" style="font-size: 20px;">+91-8872928865</span>
                </li>
                <li class="preview-info__member">
                    <span class="preview-info__name" style="font-size: 20px;">Rashi Aggarwal</span><br>
                 <span class="preview-info__role style=" style="font-size: 20px;">+91-8699052910</span>
                </li>
...
<div class="comments" id="comments">
    ...
    <div class="comments__content">
        <div class="comments__left">
            ...
            <b class="comment__author" style="font-size: 30px;">Battle Of Oratory </b>
            <p class="comment__date"></p>
            <p class="comment__text" style="font-size: 17px;">
              The participants will have to give a speech in English only. The topics will be provided on the spot. The topics will be from current affairs and other general topics. Teams will be made according to number of participants. All the rules of the debate should be followed.
   </p>
                <p>


<form method="get" action="../departmental_events/ladc/battleoforatory.php">
