...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Micro Robo War</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo"">
                                       ...
                                       <li> THERE WILL ONLY BE ONE ROUND.</li>
                                        <li>BOTS WILL BE PUT INTO THE ARENA 2 AT A TIME AND THE BOT WITH THE LESSER
POINTS IS KNOCKED OUT.</li>
...
Prize money worth Rs.2200 /-
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=29" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
