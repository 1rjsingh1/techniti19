...
<li>Final judgment by the judges</li>
                                        ...
                                        <div class="row">
                                            <!-- <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/The Next CEO2.png" class="eventImage">
                                                </center>
                                            </div> -->
                                        </div>
...
<li>Best NIT J Bidder award</li>
 ...
 <div id="RegisterContainer">
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="The Next CEO" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/The Next CEO.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/The Next CEO.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
