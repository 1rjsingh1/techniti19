...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Sci-Tech.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>techNITi19 EVENT -  Sci-Tech</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Sci-Tech</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                      This Quiz aims at testing the knowledge of students about the Science and Technology around the World.
                                    </div>
                                </div>
                            </section>
                                      ...
                                      This is preliminary round. Total of 8-10 teams will make it to next round. The screening will be
                                        ...
                                        <div class="row">
                                            <!-- <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Sci-Tech2.png" class="eventImage">
                                                </center>
                                            </div> -->
                                        </div>
 ...
 <div class="row" id="prizemoney">
     <div class="col-md-12">
         <div class="panel panel-primary" style="border: black" >
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=54" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Sci-Tech" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Sci-Tech.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Sci-Tech.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
