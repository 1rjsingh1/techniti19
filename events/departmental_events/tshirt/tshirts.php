...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/techNITi'19 T-Shirt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>techNITi19 EVENT -  techNITi'19 T-Shirt</title>
    ...
    <div id="wrapper">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                    <li><a href="#Problem"><i class="fa fa-globe"></i> Description</a></li>
                    <li><a href="#storyline"><i class="fa fa-gamepad"></i>Details:</a></li>
                    <li><a href="#rules"><i class="fa fa-list-ol"></i> Steps to buy</a></li>
                    <li><a href="#testingofbridge"><i class="fa fa-universal-access"></i>Snapshots of T-Shirts</a></li>
                    <!-- <li><a href="#judgingandscoring"><i class="fa fa-vcard-o"></i> Judging And Scoring</a></li> -->
                    <li><a href="#prize"><i class=" fa fa-clock-o"></i> Price</a></li>
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">techNITi'19 T-Shirt</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                      Here comes an another chance to book for techniti t-shirt.
For all the dayscholars and students who could not book their t-shirt earlier can do it now.
                    ...
                    <div class="panel panel-primary" style="border: black" >
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                    <li>Advance for t-shirt are 200 rupees.</li>
                                    <li>Rest money will be collected while tshirt distribution.</li>
<li>Students who wish to give cash as advance contact the numbers below.</li>

<li>Payment on number via phonepe/paytm/gpay <br> Aman Chaudhary - 9521184482</li>
            ...
            <div class="row" id="rules">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black">
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Steps to Buy</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                      Click on the link and attach the payment screenshot with it.
                                      <a style="color:white; text-decoration:underline;"
                                      href="https://forms.gle/sJDq1zs1BDVDAVyP7">Click Here</a>


                                        <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <!-- <img src="../../../images/events/techNITi'19 T-Shirt2.png" class="eventImage"> -->
                                                </center>
                                            </div>
                                        </div>
            ...
            <div class="row" id="testingofbridge">
             <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black" >
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Snapshots of T-Shirts</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12">
        <center>
          <h4>BLUE - COLLARED/POLO</h4>
            <img src="1.jpg" class="eventImage">
            <h4>RED/MEHROON - IRON MAN/ROUND NECK</h4>
              <img src="2.jpg" class="eventImage">
        </center>
    </div>
</div>
          ...
          <!-- <div class="row" id="judgingandscoring">
            ...
            <div class="row" id="prize">
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black" >
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Price</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
<li>BLUE - COLLARED/POLO - Rs. 300</li>
<li>RED/MEHROON - IRON MAN/ROUND NECK- Rs. 250</li>
            ...
            <!-- <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=48" style="display: flex; justify-content: center" id="semi-transparent-button" >BOOK HERE</a>
              </div> -->
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="techNITi'19 T-Shirt" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/techNITi'19 T-Shirt.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/techNITi'19 T-Shirt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
