...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Refurbish The Moment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Refurbish The Moment</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                      Participants have to pick up audio of any movie scene and use the audio to shoot and
                                      ...
                                      This is preliminary round. Total of 8-10 teams will make it to next round. The screening will be
                                        ...
                                        <div class="row"> -->
                                            <!-- <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Refurbish The Moment2.png" class="eventImage">
                                                </center>
                                            </div> -->
                                        <!-- </div>
...
the basis of respective marking scheme.
 ...
 <div class="row" id="prizemoney">
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Refurbish The Moment" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Refurbish The Moment.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Refurbish The Moment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
