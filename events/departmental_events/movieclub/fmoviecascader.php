    ...
    <div id="wrapper">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                    ...
                    <li><a href="https://drive.google.com/file/d/1mnK0EpkDHZWgCn6N2sH4AvA-P8vJ4mb3/view?usp=sharing" target="_blank"><i class="fa fa-file-pdf-o"></i> Rule Book</a></li>
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Fmovie Cascader</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                      Its an individual event. Participant has to write a
...
<a style="color:white; text-decoration:underline;"
 href="https://drive.google.com/file/d/1mnK0EpkDHZWgCn6N2sH4AvA-P8vJ4mb3/view?usp=sharing">Click here</a> to view rule book.
</div>
                                </div>
                            </section>
                                      ...
                                      This is preliminary round. Total of 8-10 teams will make it to next round. The screening will be
                                        ...
                                        <div class="row"> -->
                                            <!-- <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Fmovie Cascader2.png" class="eventImage">
                                                </center>
                                            </div> -->
                                        <!-- </div>
 ...
 <div class="row" id="prizemoney">
     <div class="col-md-12">
         <div class="panel panel-primary" style="border: black" >
            ...
            <div id="RegisterContainer">
               <a class="semi-transparent-button" href="../team_register.php?id=16" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Fmovie Cascader" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Fmovie Cascader.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Fmovie Cascader.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
