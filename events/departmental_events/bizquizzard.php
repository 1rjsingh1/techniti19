...
<head>
    ...
    <title>techNITi19 EVENT -  BIZ-QUIZZARD - QUEST CLUB </title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">BIZ-QUIZZARD - QUEST CLUB</div>
            ...
            <div class="row" id="EventDescription">
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                            This Quiz is related to the BUSINESS, Economics, Organisations LOGO’s, facts and other Business things.
                                    </div>
                                </div>
                            </section>
                ...
                <div class="row" id="TeamSpecification">
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black" >
                        <div class="panel-heading" style="background: black;">
            ...
            <div class="row" id="DescriptionOfRounds">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black">
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i>Description of Rounds:</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo"">
                                            ...
                                            Final Round-This is the Final Round and consists of various sub rounds and judgement will be done on the
                                            basis of respective marking scheme and top 3 will be declared as the winners of this quiz. 
                                    </div>
                                </div>
                            </section>
            ...
            <div id="RegisterContainer">
                    <a class="semi-transparent-button" href="team_register.php?id=55" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
                  </div>
                    ...
                    <form name="myForm" method="post" onsubmit="return register()" autocomplete>
                        <div class="md-form">
                            ...
                            <div style="visibility: hidden;">
                                ...
                                <div class="row">
                                    <div class="col-md-2 flex-center">
                                        <span class="flex-center" style="padding: 10px;font-size: 19px; vertical-align: baseline;text-decoration: none;"> Member5</span>
