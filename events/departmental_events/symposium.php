...
<html lang="en">
                        ...
                        <head>
                            ...
                            <title>techNITi19 EVENT -  Symposium</title>
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                                ...
                                <div id="page-wrapper">
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="eventHeading" style="text-align: center;">Symposium</div>
                                                    ...
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo" >
                                                                   <p>Paper  Presentation in all fields of Science and Engineering <br>

The main themes of the conference is <br>

• Exploring Novel Concepts in Engineering, Science and Management. <br>
• Exploring innovative strategies and solutions. <br>
• Focusing and Expanding the Significant Assessment in technology; <br>
• Invention and Innovation of New Concepts in the Field of science. <br>
• Future Challenges and Advanced Innovations in technology.
</p>
                                                            </div>
                                                        </div>
                                                    </section>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-primary" style="border: black" >
                                                <div class="panel-heading" style="background: black;">
                                                    <h3 class="panel-title"><i class="fa fa-rss"></i> Participation: </h3>
                                                </div>
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                              This Interactive exchange will take place in working groups covering the following topics : <br>
Track 1: Applied Sciences, Applied Physics, Chemistry, Mathematics and Management and Allied Topics. <br>
Track 2:  Computer Science & Engineering, Information Technology ,Electronics and Communications, Instrumentation and Control Engineering,Electrical Engineering  <br>
Track 3:  Civil Engineering , Mechanical Engineering , Industrial and Production Engineering , Aerospace Engineering
Track 4: Chemical Engineering , Biotechnology , Textile Engineering.
                                            ...
                                            <div class="panel panel-primary" style="border: black" >
                                                ...
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                                    1. The abstract for paper should be sent through mail to rrtse2019@nitj.ac.in by 29.10.2019.<br>
                                                                    2. The shortlisted candidates will be intimated by 30.10.2019.<br>
                                                                    3. Final paper should be sent for selected abstracts by the corresponding authors by 04.11.2019(midnight).<br>
                                                                    4. Paper Length should be of 4-6 pages as in the prescribed format attached.<br>
                                                                    5. Final Paper is to be presented on Nov 8,2019 with the powerpoint presentation (6 minutes + 2 minutes (Q/A session)) <br>
6.The judgement by the respective judges will be final and non-questionable. <br>
7.The Best Paper from each track will be awarded with the ‘Best paper Award’ <br>

                                                                    <h3 style="color:red;display:inline; font-weight:bolder;">Note:</h3>
                                                                        <a style="color:white; text-decoration:underline;"
                                                                    href="symposium.docx">Click here</a> to view rule book. <br>
                                                                    <h3 style="color:red;display:inline; font-weight:bolder;">Note:</h3>
                                                                        <a style="color:white; text-decoration:underline;"
                                                                    href="temp.pdf">Click here</a> to view template.
                                    ...
                                    <div class="row" id="PrizeDistribution">
                                        <div class="col-md-12">
                                            <div class="panel panel-primary" style="border: black" >
                                                <div class="panel-heading" style="background: black;">
                                                    <h3 class="panel-title"><i class="fa fa-rss"></i> Prize Distribution:</h3>
                                                </div>
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                             Prizes worth Rs 15k to be awarded to the winners.
                                                            </div>
                                                        </div>
                                                    </section>
                                                </div>
                                    ...
                                    <div id="RegisterContainer">
                                        <a class="semi-transparent-button" href="https://forms.gle/94dT41vG5vZNdPv48" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
                                      </div>
                                      ...
                                      <div class="row" id="Organizers">
                                        <div class="col-md-12">
                                            <div class="panel panel-primary" style="border: black" >
                                                <div class="panel-heading" style="background: black;">
                                                    <h3 class="panel-title"><i class="fa fa-rss"></i>Organizers:</h3>
                                                </div>
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                              <li>Arsh Goyal (9914047037)</li>
                                                              <li>Chintan Puri(8054162244)</li>
