...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">ACE OF SPACE - QUEST CLUB</div>
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                            ...
                                            <p><b>Final Round-</b> This is the Final Round and consists of various sub rounds and judgement will be done on the
                                                basis of respective marking scheme and top 3 will be declared as the winners of this quiz.</p>
									</div>
                                </div>
                            </section>
            ...
            <div id="RegisterContainer">
                    <a class="semi-transparent-button" href="team_register.php?id=56" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
                  </div>



                  <div class="row" id="EventStudentHead">
                    <div class="col-md-12">
                        <div class="panel panel-primary" style="border: black" >
                            <div class="panel-heading" style="background: black;">
                                <h3 class="panel-title"><i class="fa fa-rss"></i> Event Student Head:</h3>
                            </div>
                            <div class="panel-body">
                                <section class="feed-item">
