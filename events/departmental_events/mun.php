...
<html lang="en">
                        ...
                        <head>
                            ...
                            <title>techNITi19 EVENT -  NIT JALANDHAR MODEL UNITED NATIONS</title>
                            ...
                            <div id="wrapper">
                              ...
                              <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                                    <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                                      ...
                                      <li><a href="#rules"><i class="fa fa-gamepad"></i>EVENT GUIDELINES</a></li>
                                      <li><a href="#testingofbridge"><i class="fa fa-list-ol"></i>RULES & REGULATIONS</a></li>
                                      ...
                                      <li><a href="https://drive.google.com/open?id=0BxtqmvEEaJOXY3V3MEJiMGtCNExfTDNHVWE1UkVUc2oyeDNn" target="_blank"><i class="fa fa-file-pdf-o"></i> Rule Book</a></li>
                                ...
                                <div id="page-wrapper">
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="eventHeading" style="text-align: center;">NIT JALANDHAR MODEL UNITED NATIONS</div>
...
curricular activity in which students typically role-play delegates to the United Nations and

simulate UN committees. <br> This activity takes place at MUN conferences, which is usually organized
by a high school or college MUN club.
                                    ...
                                    <div class="row" id="rules">
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-primary" style="border: black">
                                                <div class="panel-heading" style="background: black;">
                                                    <h3 class="panel-title"><i class="fa fa-rss"></i> EVENT GUIDELINES</h3>
                                                </div>
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                              <li>The United Nations Charter describes the Secretary General – also referred to as the S.G. - as the
"chief administrative officer" of the Organization The Secretary General is considered the Captain
on Board, but their work – the overall supervision of the conference – is facilitated by the rest of the
members of the Secretariat, namely the Deputy Secretary Generals and the President of the General
Assembly.</li>
                                  <li>A delegate in a Model United Nations conference is a participant who represents a country other
than their country of origin and deliberates on issues from the country's perspective, and not from
the delegate's perspective or point of view.
                                  </li>
                                                                <div class="row">
...
conference are not subject to change.
The rules of the format are well specified and detailed.
                                                              <li>The Secretary-General has the ultimate authority in regards to the Rules of Procedure.</li>
                                                              <li>English is the official and working language of MUN conference.</li>
                                                              <li>All delegates are required to comply with the formal western attire for theMUN Sessions and
lectures.</li>
                                                              <li> Setting the agenda is the first step to be considered by the committee.</li>
                                                              <li> The motion in order to put a topic area on the agenda should be made first. This motion requires a
second.</li>
                                                              <li>Delegates can propose only topics as put forward by the Secretariat in the provisional agenda, i.e.
the topics which were set by the Secretariat prior the conference.</li>
                                                              <li> After the exhaustion of the Speaker ́s List, the Committee will immediately vote on the motion.</li>
                                                              <li>Remainig rules can be found below</li>
                                                              <h3 style="color:red;display:inline; font-weight:bolder;">Note:</h3>
                                                              <a style="color:white; text-decoration:underline;"
                                                               href="https://drive.google.com/open?id=0BxtqmvEEaJOXY3V3MEJiMGtCNExfTDNHVWE1UkVUc2oyeDNn">Click here</a> to view rule book. <br>
                                                               <a style="color:white; text-decoration:underline;"
                                                                href="https://drive.google.com/open?id=0BxtqmvEEaJOXbjJkYnQyWS1hbW5ndTFNd2pYZ3VsbW5Yc0hJ">Click here</a> to view Performa.
                                    ...
                                    <div id="RegisterContainer">
                                      ...
                                      <div class="row" id="contact">
                                        <div class="col-md-12">
                                            <div class="panel panel-primary" style="border: black" >
                                                <div class="panel-heading" style="background: black;">
                                                    <h3 class="panel-title"><i class="fa fa-rss"></i> Event Head: </h3>
                                                </div>
                                                <div class="panel-body">
                                                    <section class="feed-item">
