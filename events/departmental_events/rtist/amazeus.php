...
<body>
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Amaze Us</div>
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    ...
                                    <p>In Amaze US  the team of participants has to Build a autonomous line follower robot  with RGB sensor which should also be able to take 90 degree turn on detection of particular colour .
                    ...
                    <div class="panel panel-primary" style="border: black" >
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                   <li>Follow Black Strip(Line Follower)</li>
                                   <li>RGB small strips will be there on the path.</li>
                                   <li>Detect the colour and make decision accordingly.</li>
                                   <li>Blue: Start and travel with half speed.</li>
                                    <li>Green: Turn left(900) [travel with full speed]</li>
                                    <li>Green: Turn left(900) [travel with full speed]</li>
                                    <li>Then Go straight.</li>
                                    <li>There will be a gap of 10-15 cm between the red strip and black strip.</li>
                                    </div>
                                </div>
                            </section>
                                    ...
                                    <section class="feed-item">
                                        ...
                                        <div class="feed-item-body">
                                            <div class="text eventInfo">
                                                    ...
                                                    <li> Take turn when detects colors. </li>
 ...
 <a style="color:white; text-decoration:underline;"
  href="amazeus.pdf">Click here</a> to view rule book.
           ...
           <div class="row" id="prize">
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=4" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
