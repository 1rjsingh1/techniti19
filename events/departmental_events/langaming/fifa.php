    ...
    <div id="wrapper">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                    ...
                    <li><a href="#judgingandscoring"><i class="fa fa-vcard-o"></i> Game RULES</a></li>
...
player with fewer goals conceded will be preferred.</li>
            ...
            <div class="row" id="judgingandscoring">
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black" >
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Game RULES</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
...
the play stops in-game. (Outsides, corners, free-kicks etc).</li>
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=12" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
