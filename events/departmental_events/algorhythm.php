          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                                ...
                                <div id="page-wrapper">
                                   <div class="row">
                                        <div class="col-md-12">
                                            <div class="eventHeading" style="text-align: center;">ALGO-RHYTHM</div>
...
Jalandhar, Punjab in order to appear for phase 2 that will be held onsite on the college premises.</p><br>
                                            ...
                                            <div class="panel panel-primary" style="border: black" >
                                                ...
                                                <div class="panel-body">
                                                    <section class="feed-item">
                                                        ...
                                                        <div class="feed-item-body">
                                                            <div class="text eventInfo">
                                                                    Algo-Rhythm is an individual event where participants need to qualify the first round in
                                                                    order to appear for the onsite finale.
                                    ...
                                    <br />
                                    <div class="row" id="ImportantDates">
                                    ...
                                    <div id="RegisterContainer">
                                        <a class="semi-transparent-button" href="register.php?id=42" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
                                      </div>
