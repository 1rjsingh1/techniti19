...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Photo Manipulation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Photo Manipulation</div>
                    ...
                    <div class="panel panel-primary" style="border: black" >
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                      You just don't take a Photograph, you make it’’ manipulation involves
...
and FB Id Link , Instagram username.</li>
                                        ...
                                        <li> The decision taken by the judges shall be final and binding. In case of any
disputes NIT Jalandhar reserves the rights in its sole discretion.</li>
                                      <li>Submit your entry at : photography@nitj.ac.in</li>
                                      <h3 style="color:red;display:inline; font-weight:bolder;">Note:</h3>
                                          <a style="color:white; text-decoration:underline;"
                                      href="https://drive.google.com/file/d/1g8YdgQRnx7zJFxiaWSHU3KHB8lhfB4-2/view?usp=sharing">Click here</a> to view rule book.


                                        <!-- <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Photo Manipulation2.png" class="eventImage">
                                                </center>
                                            </div>
                                        </div> -->
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Photo Manipulation" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Photo Manipulation.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Photo Manipulation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
