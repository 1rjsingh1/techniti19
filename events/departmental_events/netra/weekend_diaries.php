...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Weekend_Diaries.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Weekend_Diaries</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Weekend Diaries</div>
...
and FB Id Link, Instagram username and a good caption.</li>
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Weekend_Diaries2.png" class="eventImage">
                                                </center>
                                            </div>
                                        </div> -->
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../register.php?id=10" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Weekend_Diaries" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Weekend_Diaries.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Weekend_Diaries.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
