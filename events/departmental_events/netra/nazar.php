...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Nazar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>techNITi19 EVENT - Nazar</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Nazar</div>
                    ...
                    <div class="panel panel-primary" style="border: black" >
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                      Use your creativity to click theme based photos. Send us entry from the
theme given.
                                    </div>
                                </div>
                            </section>
...
Number and FB Id Link , Instagram username, and a good caption .</li>
                                        ...
                                        <li>Picture size should be greater than 5 MP and mobile clicks are also
allowed. </li>
                                        <li> Submission before 9 NOV, 5 PM.</li>
                                        <li>Image EXIF data should be present and should be shown if
demanded.</li>
...
any disputes NIT Jalandhar reserves the rights in its sole discretion.</li>
                                      ...
                                      href="https://drive.google.com/file/d/1QDcyvhHVR8HzLNltwjZPXYZoFt7dWcTu/view?usp=sharing">Click here</a> to view rule book.
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Nazar2.png" class="eventImage">
                                                </center>
                                            </div>
                                        </div> -->
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../register.php?id=8" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Nazar" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Nazar.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Nazar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
