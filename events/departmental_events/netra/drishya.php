...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Drishya.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>techNITi19 EVENT - Drishya</title>
    ...
    <div id="wrapper">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse" style="background: black;">
                <ul id="active" class="nav navbar-nav side-nav" style="background: black;">
                    ...
                    <li><a href="https://drive.google.com/file/d/1YW4D09QkOtv2Nui-thMpBZxW8YZ0pWwc/view?usp=sharing" target="_blank"><i class="fa fa-file-pdf-o"></i> Rule Book</a></li>
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Drishya</div>
                    ...
                    <div class="panel panel-primary" style="border: black">
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo"">
                                       <li> All the entries mailed must have subject as Drishya_NAME_THEME</li>
...
Number and FB Id Link , Instagram username, and a good caption .</li>
                                        <li> You can send maximum of 1 photographs from each theme.</li>
                                        <li>Each entry should consist of a maximum of 2 photographs.</li>
                                        <li> Submission before 9 NOV, 5 PM.</li>
                                        <li>Mobile clicks is also allowed (picture resolution should me of 5 MP ).</li>
...
any disputes NIT Jalandhar reserves the rights in its sole discretion.</li>
                                      <li>Submit your entry at : photography@nitj.ac.in</li>
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Drishya2.png" class="eventImage">
                                                </center>
                                            </div>
                                        </div> -->
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../register.php?id=6" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Drishya" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Drishya.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Drishya.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
