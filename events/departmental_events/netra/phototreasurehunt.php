...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Photo Treasure Hunt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:35 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>techNITi19 EVENT - Photo Treasure Hunt</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">Photo Treasure Hunt</div>
                    ...
                    <div class="panel panel-primary" style="border: black" >
                        ...
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                    A treasure hunt centered around photography ! Figure out the
...
members only.</li>
                                        ...
                                        <li> Photos of different locations inside the campus will be uploaded as Insta
stories on the official page of NETRA as hints.</li>
                                        <li> Teams have to guess and reach the locations and click pictures as
specified for each round. </li>
                                        <li> Round 1 is a qualifying round where only the first 10 teams to complete
the given tasks will be selected for Round 2.</li>
                                        <li> The 10 teams will compete in Round 2 and only 5 teams with the best
pictures will be selected for Round 3.</li>
                                        <li>Teams will be judged on their creativity and quality of photos in Round
2 & 3 which will decide the final result. The result will not be based on
Round 1.</li>
...
href="https://drive.google.com/file/d/1HYjWTzs5qynvg4usn3lRw7CY5Rk8j9b8/view?usp=sharing">Click here</a> to view rule book.
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                <center>
                                                    <img src="../../../images/events/Photo Treasure Hunt2.png" class="eventImage">
                                                </center>
                                            </div>
                                        </div> -->
            ...
            <div id="RegisterContainer">
                <a class="semi-transparent-button" href="../team_register.php?id=7" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
              </div>
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="Photo Treasure Hunt" hidden />
                                    </center>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        {
            sessionStorage.setItem("path", "events/construction_and_design/Photo Treasure Hunt.html");
...
<!-- Mirrored from www.axisvnit.org/events/construction_and_design/Photo Treasure Hunt.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2019 06:47:37 GMT -->
</html>
