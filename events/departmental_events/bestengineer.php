...
<head>
    ...
    <title>techNITi19 EVENT -  BEST ENGINEER </title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-md-12">
                    <div class="eventHeading" style="text-align: center;">BEST ENGINEER</div>
            ...
            <div class="row" id="EventDescription">
                            ...
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo" >
                                            ...
                                            given by another participant.

                                            <br>Two categories of participants-
                                            <li> Problem Identifier</li>
                ...
                <div class="row" id="EventLevel">
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black" >
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Event Level:</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
                                ...
                                <div class="feed-item-body">
                                    <div class="text eventInfo">
                                            <b>Level 1</b>- All the problems from the college recognised by the participants and framed as a problem
                                            statement. Filtering of valid problems at this level.<br>

                                            <b>Level 2</b>- Formation of teams of 2 members each - one problem identifier and one problem solver.
                                            Random formation of teams (basically on the chit system).Problem solver gives a well-explained
                                            solution. The approach is checked.
                                  </div>
                                </div>
                            </section>
            ...
            <div class="row" id="Rules">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary" style="border: black">
                        <div class="panel-heading" style="background: black;">
                            <h3 class="panel-title"><i class="fa fa-rss"></i>Rules:</h3>
                        </div>
                        <div class="panel-body">
                            <section class="feed-item">
            ...
            <div id="RegisterContainer">
                    <a class="semi-transparent-button" href="team_register.php?id=33" style="display: flex; justify-content: center" id="semi-transparent-button" >REGISTER HERE</a>
                  </div>


                  <div class="row" id="EventCoordinators">
                    <div class="col-md-12">
                           <div class="panel panel-primary" style="border: black" >
                               <div class="panel-heading" style="background: black;">
                                   <h3 class="panel-title"><i class="fa fa-rss"></i> Event Coordinators:</h3>
                               </div>
                               <div class="panel-body">
                                   <section class="feed-item">
                    ...
                    <form name="myForm" method="post" onsubmit="return register()" autocomplete>
                        <div class="md-form">
                            ...
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col-md-12">
                                    <center>
                                        ...
                                        <input type="text" name="eventName" value="ACE OF SPACE-QUEST CLUB" hidden />
                                    </center>
                                </div>
                            </div>
                            ...
                            <div style="visibility: hidden;">
                                ...
                                <div class="row">
                                    <div class="col-md-2 flex-center">
                                        <span class="flex-center" style="padding: 10px;font-size: 19px; vertical-align: baseline;text-decoration: none;"> Member4</span>
                                    ...
                                    <div class="col-md-2">
                                      <input type="text" name="contact4" placeholder="Contact No." style="color: white;font-size: 17px;max-width: 90%;" id="inputValidationEx" class="form-control validate" />

                                    </div>
                                    <div class="col-md-2">
                                      <input type="text" name="college4" placeholder="College" style="color: white;font-size: 17px;max-width: 90%;" id="inputValidationEx" class="form-control validate" />
